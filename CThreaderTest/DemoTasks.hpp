...
namespace Workloads {
    ...
    // =========================================
    // YARDIMCI FONKSÝYONLAR (Benchmark hazýrlýðý için)
    // =========================================
    ...
    // =========================================
    // ÝÞ YÜKÜ SENARYOLARI (TASKS)
    // =========================================

    // SENARYO 1: Aðýr Matematik (FPU Bound)
    double Task1_HeavyMath(long long iterations);

    // SENARYO 2: Matris Çarpýmý (CPU & Cache Bound)
    ...
    // SENARYO 4: Rastgele Bellek Eriþimi (Latency Bound)
    ...
    // SENARYO 6: Sýralama ve Arama (Branch Prediction Bound)
    long long Task6_SortAndSearch(std::vector<int> data);

    // SENARYO 7: Asal Sayý Bulma - Trial Division (CPU Bound - Integer Division)
    ...
    // SENARYO 14: Sýkýþtýrma Simülasyonu (Memory Alloc Intense)
