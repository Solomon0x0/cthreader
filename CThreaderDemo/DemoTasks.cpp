...
namespace Workloads {
    ...
    // GÖREV 3: Görüntü İşleme Simülasyonu (Memory Bandwidth)
    void ImageProcessing(std::vector<double>& data, size_t start_index, size_t end_index) {
        ...
        for (size_t i = start_index; i < end_index; ++i) {
            // Piksel başına ağır bir filtre simülasyonu
            double val = data[i];
            for (int j = 0; j < 20; ++j) {
